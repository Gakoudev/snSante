...
import 'package:snsante/services/ambulance_service.dart';
import '../styles/colors.dart';
import '../widgets/button_neumorphic.dart';
import '../widgets/heardersecond.dart';

class MapAmbulancePage extends StatefulWidget{
  
  MapAmbulancePage({super.key});

  
  @override
  _MapAmbulancePageState createState() => _MapAmbulancePageState();
}

class _MapAmbulancePageState extends State<MapAmbulancePage> {
  AmbulanceService mapController = Get.put(AmbulanceService());
